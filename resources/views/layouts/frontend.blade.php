    ...
    <header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 w-full border-b border-border/40 bg-background">
        <div class="container mx-auto flex h-16 items-center justify-between px-4 sm:px-8">
            ...
            <nav class="hidden md:flex items-center gap-6 text-sm font-medium text-foreground/80">
                ...
                <a href="/public-sector" class="flex items-center gap-2 transition-colors hover:text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <line x1="6" x2="6" y1="10" y2="22" />
                        <line x1="10" x2="10" y1="10" y2="22" />
                        <line x1="14" x2="14" y1="10" y2="22" />
                        <line x1="18" x2="18" y1="10" y2="22" />
                ...
                <div class="relative group h-full flex items-center">
                    <button class="flex items-center gap-1 transition-colors hover:text-primary focus:outline-none">
                        About
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="transition-transform duration-200 group-hover:rotate-180">
                            <path d="m6 9 6 6 6-6" />
                        </svg>
                    </button>
                    <!-- Dropdown Menu -->
                    <div
                        class="absolute right-0 top-full pt-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 ease-out translate-y-2 group-hover:translate-y-0">
            ...
            <div class="flex items-center gap-4">
                <a href="/contact"
                    class="hidden md:inline-flex group relative items-center justify-center rounded-full text-sm font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-r from-[#3b0764] via-[#6d28d9] to-[#3b0764] bg-[length:200%_auto] hover:bg-right text-white h-11 px-8 shadow-lg hover:shadow-[#3b0764]/50 hover:-translate-y-0.5 overflow-hidden">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round"
                        class="relative z-10 ml-2 animate-wiggle transition-transform duration-300 group-hover:translate-x-1 group-hover:animate-none">
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden p-2 text-foreground/80 hover:text-foreground focus:outline-none">
                    <svg x-show="!mobileMenuOpen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            ...
            <nav class="flex flex-col p-4 space-y-10">
                ...
                <div x-data="{ aboutOpen: false }">
                    <button @click="aboutOpen = !aboutOpen"
                        class="flex items-center justify-between w-full text-sm font-medium text-foreground/80 hover:text-primary transition-colors">
                        <span class="flex items-center gap-1">
                            About
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="transition-transform duration-200" :class="{ 'rotate-180': aboutOpen }">
                            <path d="m6 9 6 6 6-6" />
                        </svg>
                    </button>
                ...
                <a href="/contact"
                    class="flex items-center justify-center rounded-md bg-primary text-primary-foreground h-10 px-4 text-sm font-medium shadow transition-colors hover:bg-primary/90">
                    <div class="absolute inset-0 -translate-x-full animate-shine bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
                    <span class="relative z-10">Contact Us</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        @endif
                        @if (!empty($footerSettings['footer_social_linkedin']))
                            <a href="{{ $footerSettings['footer_social_linkedin'] }}" class="text-muted-foreground hover:text-primary transition-colors" aria-label="linkedin">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-center gap-3 text-sm text-muted-foreground">
                            ...
                            <a href="mailto:{{ $footerSettings['footer_email'] ?? 'info@rigorequity.com' }}"
                                class="hover:text-primary transition-colors">{{ $footerSettings['footer_email'] ?? 'info@rigorequity.com' }}</a>
                        </li>
                        <li class="flex items-center gap-3 text-sm text-muted-foreground">
                            <svg class="h-5 w-5 shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="tel:{{ $footerSettings['footer_phone'] ?? '+1234567890' }}"
                                class="hover:text-primary transition-colors">{{ $footerSettings['footer_phone'] ?? '+1 (234) 567-890' }}</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="h-40 w-full rounded-lg overflow-hidden border border-border bg-muted relative group">
                        <iframe
                            src="{{ $footerSettings['footer_map_iframe'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes%20Square!5e0!3m2!1sen!2sus!4v1622207901399!5m2!1sen!2sus' }}"
