    ...
    <section class="py-24 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Chicago Public Sector Construction FAQ</h2>
                <p class="text-xl text-gray-600">Common questions about our public sector development, municipal partnerships, compliance standards, and construction management services.</p>
            </div>
