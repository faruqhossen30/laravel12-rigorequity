...
@section('title', 'Construction Page Settings')
...
<div class="page-header">
    <div>
        <h1 class="page-title">Construction Page Settings</h1>
        <p class="page-description">Manage content and SEO for the Construction page.</p>
    </div>
</div>
