...
@section('title', 'Public Sector Page Settings')
...
<div class="page-header">
    <div>
        <h1 class="page-title">Public Sector Page Settings</h1>
        <p class="page-description">Manage content and SEO for the Public Sector page.</p>
    </div>
</div>
