...
@section('title', 'Investment Management Page Settings')
...
<div class="page-header">
    <div>
        <h1 class="page-title">Investment Management Page Settings</h1>
        <p class="page-description">Manage content and SEO for the Investment Management page.</p>
    </div>
</div>
