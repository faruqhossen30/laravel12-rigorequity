...
<div class="page-header">
    <div>
        ...
        <p class="page-description">Manage content for the site-wide footer.</p>
    </div>
</div>
...
<form action="{{ route('settings.update') }}" method="POST">
    ...
    <div class="card" style="margin-bottom: 1.5rem;">
        <div class="card-header">
            <h3 class="card-title" style="text-transform: capitalize;">{{ str_replace('_', ' ', str_replace('footer_', '', $group)) }} Settings</h3>
        </div>
        <div class="card-body">
